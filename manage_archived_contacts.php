...
<head>
    ...
    <title>Archived Contacts | Invoice Management System</title>
                ...
                <div class="container-fluid px-3 px-lg-4 py-4">
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                            <span class="fw-bold">Archived Contacts</span>

                            <button class="btn btn-primary btn-sm" id="contactsBtn">
                                Contacts
                            </button>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#contactsTable').DataTable({
                ajax: {
                    url: "php/manage_all_archived_contacts.php",
                    dataSrc: ""
                },
                columns: [{
            ...
            //Unarchive multiple 
            $('#unarchiveSelected').on('click', function() {
                ...
                Swal.fire({
                    title: "unarchive selected contacts?",
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "php/unarchive_multiple_contacts.php",
                            type: "POST",
                            data: {
                                ids: ids
                            },
                            success: function(response) {
                                ...
                                if (response.trim() === "success") {
                                    ...
                                    Swal.fire("Unarchived!", "Contacts unarchived successfully", "success");
            ...
            $('#contactsTable tbody').on('click', 'tr', function(e) {
                ...
                // Don't redirect when edit/delete button clicked
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.trim() === "success") {
                            ...
                            Swal.fire("Unarchived!", "Contact has been Unarchived", "success");
