    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#productsTable').DataTable({
                ...
                ajax: {
                    url: "php/manage_all_archived_products.php",
                    dataSrc: ""
                },
                responsive: true,
                autoWidth: false,
            ...
            $('#unarchiveSelected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    text: "Do you want to unarchive selected products",
                    icon: "info",
                    showCancelButton: true,
                    confirmButtonColor: "#d33",
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "php/unarchive_multiple_products.php",
                            type: "POST",
                            data: {
                                ids: ids
                            },
                            success: function(response) {
                                ...
                                if (response.trim() === "success") {
                                    ...
                                    Swal.fire("Unarchived!", "Products unarchived successfully", "success");
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.trim() === "success") {
                            ...
                            Swal.fire("Unarchived!", "Product has been Unarchived", "success");
